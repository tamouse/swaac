* Setting up your Mac for working on the command line.
  :PROPERTIES:
  :CUSTOM_ID: setting-up-your-mac-for-working-on-the-command-line.
  :END:
...
** Gathering Current Information
   :PROPERTIES:
   :CUSTOM_ID: gathering-current-information
   :END:
...
** If you don't have any of the three files
   :PROPERTIES:
   :CUSTOM_ID: if-you-dont-have-any-of-the-three-files
   :END:
...
*** What are the =.bash_profile= and =.profile= file about?
    :PROPERTIES:
    :CUSTOM_ID: what-are-the-.bash_profile-and-.profile-file-about
    :END:
...
** If you have =.bash_profile=, but none of the others
   :PROPERTIES:
   :CUSTOM_ID: if-you-have-.bash_profile-but-none-of-the-others
   :END:
...
** If you have =.profile=, but none of the others
   :PROPERTIES:
   :CUSTOM_ID: if-you-have-.profile-but-none-of-the-others
   :END:
...
** If you do NOT have a =.bashrc= file
   :PROPERTIES:
   :CUSTOM_ID: if-you-do-not-have-a-.bashrc-file
   :END:
...
*** What is the =.bashrc= file all about?
    :PROPERTIES:
    :CUSTOM_ID: what-is-the-.bashrc-file-all-about
    :END:
...
*** Creating the =.bashrc= file
    :PROPERTIES:
    :CUSTOM_ID: creating-the-.bashrc-file
    :END:
...
** If you have =.bashrc= but neither =.bash_profile= or =.profile=
   :PROPERTIES:
   :CUSTOM_ID: if-you-have-.bashrc-but-neither-.bash_profile-or-.profile
   :END:
...
** If you have =.bashrc=, and one or both of =.bash_profile= and =.profile=
   :PROPERTIES:
   :CUSTOM_ID: if-you-have-.bashrc-and-one-or-both-of-.bash_profile-and-.profile
   :END:
