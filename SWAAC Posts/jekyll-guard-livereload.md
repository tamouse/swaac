...
Recently looking around, and chatting with some folks on the `#jekyll` irc channel on freenode, I started to rethink the work I\'d done creating the [drink~updoctor~](https://github.com/tamouse/drink_up_doctor) gem using [Gulp](http://gulpjs.com) to drive the work cycle.
